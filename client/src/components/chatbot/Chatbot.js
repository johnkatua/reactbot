...
class Chatbot extends Component {
  ...
  async df_text_query(text) {
    ...
    const res = await axios.post('http://localhost:4000/api/df_text_query', {text: text, userID: cookies.get('userID')});
  ...
  async df_event_query(eventName) {   
    const res = await axios.post('http://localhost:4000/api/df_event_query', {event: eventName, userID: cookies.get('userID')});
    console.log(res);
